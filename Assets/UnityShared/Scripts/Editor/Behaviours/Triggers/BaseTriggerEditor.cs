...
{
    public class BaseTriggerEditor<TEnum> : UnityEditor.Editor where TEnum : Enum
    {
        public string addButtonText = "Add New Event Type";
